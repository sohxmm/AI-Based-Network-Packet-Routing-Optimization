...
graph TD
    subgraph Frontend [React + Vite Dashboard]
        UI[User Interface]
        Graph[Topology Graph / D3.js]
        Stats[Live Analytics]
    end

    subgraph Backend [FastAPI Server]
        API[REST & WebSockets]
        Sim[Network Simulator Engine]
        Models[AI / ML Models]
    ...
    UI <-->|HTTP/REST| API
    Graph <-->|WebSockets| API
    Stats <-->|WebSockets| API

    API --> Sim
    Sim <--> Router
    Router <--> Models
    Sim -->|Snapshots & Events| DB
```
...
<div align="center">
<i>Developed as part of the Algorithm & AI/ML Internship Team project.</i>
</div>
